...
const LatestBlog = () => {
  return (
    <section className="related-blog-list ptb-120 bg-dark">
            ...
            <div key={i + 1} className="col-lg-4 col-md-6">
              <div className="single-article rounded-custom mb-4 mb-lg-0">
                ...
                <div className="article-content p-4">
                  ...
                  <Link href="/blog-single">
                    <a>
                      <h2 className="h5 article-title text-dark limit-2-line-text">
                        {blog.header}
                      </h2>
                    </a>
                  </Link>
                  <p className="limit-2-line-text text-dark">{blog.info}</p>
